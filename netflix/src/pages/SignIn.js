        ...
        <>
          ...
          <form>
            <input
              ...
              id="email"
              type="mail"
              className="signIn__input__mail"
              placeholder="Email"
            />
            <div
              id="alert"
              className={`alertSignIn login__body__alert ${
            ...
            <input
              ref={passwordRef}
              type="password"
              className="signIn__input__password"
            ...
            <div
              id="alert__error"
              className={`alertSignIn alert__error login__body__alert ${
                showAlert && "show__alert"
              }`}
            />
