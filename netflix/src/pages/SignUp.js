...
function SignUp({ mail }) {
  ...
  useEffect(() => {
    ...
    document.getElementsByClassName("login__banner")[0].style.cursor =
      "pointer";
  }, []);
        ...
        <>
          ...
          <form>
            <input
              ...
              id="email"
              type="mail"
              className="signUp__input__mail"
              placeholder="Email"
            />
            <div
              id="alert"
              className={`alertSignUp login__body__alert ${
                showAlert && "show__alert"
              }`}
            />
            <input
              ref={passwordRef}
              type="password"
              className="signUp__input__password"
            ...
            <div
              id="alert__error"
              className={`alertSignUp alert__error login__body__alert ${
                showAlert && "show__alert"
              }`}
            />
            <h4 className="signIn__signUp">
              <span className="signUp__span__gray">
                {" "}
                Already have an account?{" "}
              </span>
              <span
                onClick={() => setSignIn(true)}
                className="signUp__span__white"
              >
                {" "}
                Sign in now.{" "}
              </span>
